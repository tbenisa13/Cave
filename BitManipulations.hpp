...
long int DivideWithoutUsingDivision(int x, int y);
...
int longestSubstringOf1s_afterRemoving_1bit(std::string s);
int longestSubstringOf1s_afterRemoving_1bit_2( std::string str );

// Binary strings stuff
int PatternCount_1(std::string str);

int findEqualLengths_of_Zeros_Ones_1( std::vector<int>& nums );

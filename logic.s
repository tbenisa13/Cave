	...
	.globl	__Z7LogicORbb                   ## -- Begin function _Z7LogicORbb
	.p2align	4, 0x90
__Z7LogicORbb:                          ## @_Z7LogicORbb
	.cfi_startproc
## %bb.0:
	pushq	%rbp
...
## %bb.0:
	...
	.cfi_endproc
                                        ## -- End function
	.globl	__Z8LogicANDbb                  ## -- Begin function _Z8LogicANDbb
	.p2align	4, 0x90
__Z8LogicANDbb:                         ## @_Z8LogicANDbb
	.cfi_startproc
## %bb.0:
	pushq	%rbp
	.cfi_def_cfa_offset 16
...
L_.str.5:                               ## @.str.5
	.asciz	"Both A and B are False: A = "
...
L_.str.9:                               ## @.str.9
	.asciz	"Both A and B are Fasle: A = "

L_.str.10:                              ## @.str.10
	.asciz	"A is Fasle: A = "

L_.str.11:                              ## @.str.11
	.asciz	"Both B is Fasle: A = "
